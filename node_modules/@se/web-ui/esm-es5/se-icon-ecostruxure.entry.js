...
var iconEcostruxureCss = ":host{height:auto;font-size:12px !important;color:inherit;fill:currentColor}.medium svg{width:144px;height:27px}.inherited{-webkit-filter:brightness(0) invert(1);filter:brightness(0) invert(1)}";
var IconEcostruxureComponent = /** @class */ (function () {
    function IconEcostruxureComponent(hostRef) {
    ...
    IconEcostruxureComponent.prototype.render = function () {
        return h("span", { class: [this.size, this.color].join(' '), innerHTML: IconEcostruxure });
    };
    return IconEcostruxureComponent;
}());
IconEcostruxureComponent.style = iconEcostruxureCss;
export { IconEcostruxureComponent as se_icon_ecostruxure };
