...
var CheckboxComponent = /** @class */ (function () {
     ...
     */
    class_1.prototype.setRequired = function () {
    ...
    class_1.prototype.setElementId = function () {
    ...
    class_1.prototype.handleClick = function () {
        if (!this.disabled) {
            ...
            var checkboxObject = { value: this.value, selected: this.selected };
    ...
    class_1.prototype.render = function () {
        ...
        if (this.option === 'onoff') {
            markup = (h("div", { class: "on-off-wrapper" }, h("button", { class: ['active', this.selected ? ' selected' : ''].join(' '), onClick: function () { return _this.handleClick(); } }, this.textOn), h("button", { class: ['inactive', !this.selected ? ' selected' : ''].join(' '), onClick: function () { return _this.handleClick(); } }, this.textOff)));
        }
        else {
            markup = (h("div", { class: "checkbox-wrapper" }, this.option === 'switch' && this.labelPos === 'left' ? switchMarkup : '', h("label", { class: ["checkbox-container", "checkbox-label-" + this.labelPos].join(' '), "data-disabled": this.disabled }, this.option === 'checkbox' ? this.label : '', this.option === 'checkbox' && this.required ? h("span", { class: "required" }, "*") : '', h("input", { type: "checkbox", checked: this.selected, disabled: this.disabled, onClick: function () { return _this.handleClick(); }, value: this.value }), h("span", { class: "checkmark", "data-color": this.color })), this.option === 'switch' && this.labelPos === 'right' ? switchMarkup : ''));
        }
...
var ChipComponent = /** @class */ (function () {
    ...
    ChipComponent.prototype.closeChip = function () {
        if (!this.disabled) {
            this.didClose.emit(this.value);
        }
    };
    ChipComponent.prototype.render = function () {
        var _this = this;
        return (h("div", { class: [
                'se-chip',
                this.size,
            ...
            ].join(' ') }, h("div", { class: ['value', this.canClose ? 'can-close' : ''].join(' ') }, this.value), this.canClose ? h("se-icon", { class: "close", onClick: function () { return _this.closeChip(); } }, h("span", { innerHTML: action_delete_cross })) : ''));
    };
    Object.defineProperty(ChipComponent.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
...
var FormFieldComponent = /** @class */ (function () {
    ...
    FormFieldComponent.prototype.inputSelectListenerHandler = function (event) {
        this.handleEvent(event);
    };
    FormFieldComponent.prototype.checkboxListenerHandler = function (event) {
        this.handleEvent(event);
    };
    FormFieldComponent.prototype.radioListenerHandler = function (event) {
        this.handleEvent(event);
    };
    FormFieldComponent.prototype.disabledDidChange = function () {
        this.initLabel();
    };
    FormFieldComponent.prototype.typeDidChange = function () {
        this.initLabel();
    };
    FormFieldComponent.prototype.initLabel = function () {
        var _this = this;
        Array.from(this.el.querySelectorAll('input, select, textarea, se-checkbox, se-radio')).forEach(function (item) {
            item.disabled = _this.disabled;
        });
    };
    FormFieldComponent.prototype.componentDidLoad = function () {
        this.initLabel();
    };
    FormFieldComponent.prototype.handleEvent = function (event) {
        if (!this.disabled) {
    ...
    FormFieldComponent.prototype.render = function () {
        ...
        return (h("div", { class: (_a = {},
                _a["ff-" + this.status] = true,
                _a['ff-stacked'] = this.option === 'stacked',
                _a['ff-block'] = this.block,
                _a["ff-padding-" + this.padding] = true,
                _a['form-field-wrapper'] = true,
                _a) }, h("label", { "data-disabled": this.disabled }, h("span", { style: {
    ...
    Object.defineProperty(FormFieldComponent.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(FormFieldComponent, "watchers", {
        get: function () {
            return {
...
var RadioComponent = /** @class */ (function () {
     ...
     */
    class_2.prototype.setRequired = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.required = true;
                return [2 /*return*/];
    ...
    class_2.prototype.setInputId = function () {
        var id = this.el.getAttribute('id');
        if (id) {
    ...
    class_2.prototype.handleClick = function () {
        this.selected = !this.selected;
        var checkboxObject = { value: this.value, selected: this.selected };
    ...
    class_2.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "se-radio" }, h("label", { class: ["radio-container", "checkdot-label-" + this.labelPos].join(' '), "data-disabled": this.disabled }, this.label, this.required ? h("span", { class: "required" }, "*") : '', h("input", { type: "radio", checked: this.selected, disabled: this.disabled, onClick: function () { return _this.handleClick(); } }), h("span", { class: "checkdot", "data-color": this.color }))));
    };
...
var radioGroupCss = ":host{font-size:0}::slotted(se-radio){display:block;padding:4px 0}";
var RadioGroupComponent = /** @class */ (function () {
    function RadioGroupComponent(hostRef) {
        registerInstance(this, hostRef);
        /**
    ...
    RadioGroupComponent.prototype.disabledDidChange = function () {
        this.updateItemMode();
    };
    RadioGroupComponent.prototype.valueDidChange = function (value) {
        this.selectChild(this.children, value);
        this.didChange.emit(this.value);
    };
    RadioGroupComponent.prototype.buttonClickedHandler = function (event) {
        this.handleChildClicked(event);
    };
    RadioGroupComponent.prototype.radioButtonCheckedHandler = function (event) {
        this.handleChildClicked(event);
    };
    RadioGroupComponent.prototype.updateItemMode = function () {
        var _this = this;
        this.children.forEach(function (child) {
            ...
            child.size = _this.size;
            child.color = _this.color;
        });
    };
    RadioGroupComponent.prototype.handleChildClicked = function (event) {
        var buttonInfo = event.detail;
        this.value = buttonInfo.value;
        this.selectChild(this.children, this.value);
        this.didChange.emit(this.value);
    };
    RadioGroupComponent.prototype.selectChild = function (children, value) {
        children.forEach(function (child) {
            child.selected = child.value === value;
        });
    };
    RadioGroupComponent.prototype.componentDidLoad = function () {
    ...
    Object.defineProperty(RadioGroupComponent.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RadioGroupComponent, "watchers", {
        get: function () {
            return {
                "disabled": ["disabledDidChange"],
...
export { CheckboxComponent as se_checkbox, ChipComponent as se_chip, FormFieldComponent as se_form_field, RadioComponent as se_radio, RadioGroupComponent as se_radio_group };
