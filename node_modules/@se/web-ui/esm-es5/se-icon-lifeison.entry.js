...
var iconLifeisonCss = ":host{height:auto;font-size:12px !important;color:inherit;fill:currentColor;width:100%}.inherited{-webkit-filter:brightness(0) invert(1);filter:brightness(0) invert(1)}";
var IconLifeisonComponent = /** @class */ (function () {
    function IconLifeisonComponent(hostRef) {
    ...
    IconLifeisonComponent.prototype.render = function () {
        return h("span", { class: this.color, innerHTML: IconLifeison });
    };
    return IconLifeisonComponent;
}());
IconLifeisonComponent.style = iconLifeisonCss;
export { IconLifeisonComponent as se_icon_lifeison };
