...
var ButtonComponent = /** @class */ (function () {
    ...
    class_1.prototype.optionDidChange = function () {
     ...
     */
    class_1.prototype.setDisabled = function (val) {
     ...
     */
    class_1.prototype.setGrouped = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.grouped = true;
                return [2 /*return*/];
    ...
    class_1.prototype.buttonClickedHandler = function (ev) {
        if (this.type !== 'button') {
            ...
            if (form) {
                ev.preventDefault();
                var fakeButton = window.document.createElement('button');
    ...
    class_1.prototype.setButtonId = function () {
    ...
    class_1.prototype.render = function () {
        var _a;
        var _this = this;
        var _b = this, color = _b.color, size = _b.size, option = _b.option, icon = _b.icon, iconColor = _b.iconColor, iconOnly = _b.iconOnly, selected = _b.selected;
        var isIconOnly = iconOnly || option && option.includes('fab');
        return (h(Host, { class: { 'disabled': this.disabled, 'grouped': this.grouped, 'display-block': this.block, 'minifab': this.option === 'minifab' } }, h("button", { disabled: this.disabled, "data-tooltip": this.caption, type: this.type, id: this.innerId, onClick: function () { return _this.toggle(); }, class: (_a = {},
                _a[color] = true,
                _a[size] = true,
                _a[option] = true,
                _a['selected'] = selected,
                _a['iconOnly'] = isIconOnly,
                _a) }, icon && h("se-icon", { size: this.grouped && this.size !== 'nano' ? 'medium' : 'small', color: iconColor }, icon), h("slot", { name: "icon" }), !isIconOnly && h("span", { class: "text" }, h("slot", null)))));
    };
...
export { ButtonComponent as se_button };
