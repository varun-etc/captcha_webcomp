...
var SnackbarComponent = /** @class */ (function () {
    ...
    SnackbarComponent.prototype.openDidChange = function () {
        var _this = this;
        if (this.open) {
    ...
    SnackbarComponent.prototype.submitData = function () {
        this.actionClicked.emit();
    };
    SnackbarComponent.prototype.componentDidLoad = function () {
        this.openDidChange();
    };
    SnackbarComponent.prototype.render = function () {
        var _this = this;
        var renderIcon = this.icon === 'information_circle' ? information_circle : this.icon;
        if (this.icon === "none") {
            renderIcon = false;
        }
        return (h("div", { class: this.type }, h("div", { class: "snackbar", role: "alert" }, h("span", { class: "snackbar-icon" }, renderIcon && h("se-icon", null, h("span", { innerHTML: renderIcon })), h("slot", { name: "icon" })), h("span", { class: "message" }, this.message, h("slot", null)), this.actionText ? h("span", { class: "action", onClick: function () { return _this.submitData(); } }, this.actionText) : '', this.canClose ? h("span", { class: "close" }, h("se-icon", { onClick: function () { return _this.closeSnackbar(); } }, h("span", { innerHTML: action_delete_cross }))) : '')));
    };
    Object.defineProperty(SnackbarComponent.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SnackbarComponent, "watchers", {
        get: function () {
            return {
                "open": ["openDidChange"]
            };
...
export { SnackbarComponent as se_snackbar };
