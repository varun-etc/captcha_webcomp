...
var iconSchneiderCss = ":host{margin-right:5px;color:#009530 !important;fill:currentColor}svg{margin-bottom:-11px;margin-top:-7px;height:60px}";
var IconSchneiderComponent = /** @class */ (function () {
    function IconSchneiderComponent(hostRef) {
        registerInstance(this, hostRef);
    }
    IconSchneiderComponent.prototype.render = function () {
        return h("span", { innerHTML: IconSchneider });
    };
    return IconSchneiderComponent;
}());
IconSchneiderComponent.style = iconSchneiderCss;
export { IconSchneiderComponent as se_icon_schneider };
