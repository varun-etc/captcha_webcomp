...
const TabbarComponent = class {
    ...
    render() {
        return (index.h("div", { class: [`tab-${this.color}`, "d-flex-main", `opt-${this.option}`].join(' ') }, index.h("div", { class: "nav-left-wrapper centered" }, index.h("slot", { name: "start" })), index.h("div", { class: ["fill-space", "nav-center-wrapper", `opt-${this.option}`, !!this.overflow ? this.overflow : ''].join(' ') }, index.h("slot", null)), index.h("div", { class: [`tab-end-${this.color}`, `opt-end-${this.option}`, "centered"].join(' ') }, index.h("slot", { name: "end" })), index.h("div", { class: [`tab-end-${this.color}`, `opt-end-${this.option}`, "centered", "edge"].join(' ') }, index.h("slot", { name: "edge" }))));
    }
};
TabbarComponent.style = tabbarCss;

exports.se_tabbar = TabbarComponent;
