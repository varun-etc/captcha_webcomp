...
const BlockComponent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: [
            ...
            ].join(' ') }, this.loading ? index.h("se-loading", { loading: this.loading }) : '', index.h("slot", null))));
    }
...
const blockContentCss = ":host{overflow-x:hidden;position:relative;-moz-flex:1 1 auto;-ms-flex:1 1 auto;flex:1 1 auto}.se-block-content{padding:8px 16px}.fill-content{padding:0}";
...
const BlockContent = class {
    ...
    render() {
        return (index.h("div", { class: ['se-block-content', this.option ? `${this.option}-content` : ''].join(' ') }, index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
BlockContent.style = blockContentCss;

const blockFooterCss = ".se-block-footer{position:relative;padding:4px;min-height:40px;-moz-align-items:center;-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex}.flex{-moz-flex:1 1 auto;-ms-flex:1 1 auto;flex:1 1 auto}.card{border-top:none}.column{-moz-flex-direction:column;-ms-flex-direction:column;flex-direction:column}";
...
const BlockFooter = class {
    ...
    render() {
        return (index.h(index.Host, null, this.divider ? index.h("se-divider", null) : null, index.h("div", { class: ['se-block-footer', this.option, this.direction].join(' ') }, index.h("div", { class: "flex" }, index.h("slot", { name: "start" })), index.h("slot", null))));
    }
    get el() { return index.getElement(this); }
};
BlockFooter.style = blockFooterCss;

const blockHeaderCss = ".se-block-header{position:relative;padding:4px 4px 2px 8px;font-size:20px;min-height:40px;-moz-align-items:center;-ms-flex-align:center;align-items:center;display:-ms-flexbox;display:flex}.flex{-moz-flex:1 1 auto;-ms-flex:1 1 auto;flex:1 1 auto}div.middle{font-weight:300;line-height:30px;font-size:22px;margin:8px}.card{padding-bottom:4px}.fill{padding:0}.fill div.middle{margin:0;max-width:100%}::slotted(h1),::slotted(h2),::slotted(h3),::slotted(h4),::slotted(h5),::slotted(h6){margin-top:0 !important;margin-bottom:0 !important}";
...
const ContainerComponent = class {
    ...
    render() {
        return (index.h(index.Host, { class: [
                ...
                .join(' ') }, this.option === "centered" ? index.h("div", { class: "wrapper-center" }, index.h("slot", null)) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "option": ["optionDidChange"],
...
const dividerCss = ".se-divider{display:block;margin:0}.se-divider.horizontal{width:100%;border-top:1px solid}.se-divider.vertical,.se-divider.inset{height:100%;border-right:1px solid}.se-divider.standard{border-color:#E6E6E6}.se-divider.alternative{border-color:#FFFFFF;border-color:var(--se-alternative, #FFFFFF)}";
...
const DividerComponent = class {
    ...
    render() {
        return index.h("div", { class: ['se-divider', this.option, this.color].join(' ') });
    }
};
DividerComponent.style = dividerCss;

exports.se_app = AppComponent;
exports.se_block = BlockComponent;
exports.se_block_content = BlockContent;
exports.se_block_footer = BlockFooter;
exports.se_block_header = BlockHeader;
exports.se_container = ContainerComponent;
exports.se_divider = DividerComponent;
