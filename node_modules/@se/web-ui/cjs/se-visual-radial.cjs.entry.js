...
const VisualRadialComponent = class {
    ...
    render() {
        return (index.h(index.Host, { class: !this.isHexColor ? `color-${this.secolor}` : '' }, index.h("div", { class: ["visual-radial-wrapper", this.size].join(' ') }, index.h("svg", { class: "se-visual-radial", height: this.svgSize, width: this.svgSize }, index.h("circle", { cx: this.circleDimensions, cy: this.circleDimensions, r: this.circleRadius, stroke: "#f7f7f7", "stroke-width": "8", fill: "transparent" }), index.h("circle", { cx: this.circleDimensions, cy: this.circleDimensions, r: this.circleRadius, stroke: this.isHexColor ? this.secolor : 'currentColor', "stroke-width": "8", fill: "transparent", style: { strokeDashoffset: String(this.offset) } }), "Sorry, your browser does not support inline SVG."), index.h("svg", { height: this.svgSize, width: this.svgSize }, index.h("text", null, this.value ? index.h("tspan", { class: "radial-value", x: "50%", y: "50%", "text-anchor": "middle" }, this.value) : '', index.h("tspan", { class: "radial-label", x: "50%", y: this.value ? "70%" : "53%", "text-anchor": "middle" }, this.label))))));
    }
...
exports.se_visual_radial = VisualRadialComponent;
