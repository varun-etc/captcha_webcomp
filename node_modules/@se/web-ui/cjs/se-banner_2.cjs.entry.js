...
const arrow2_left = `<?xml version="1.0" encoding="utf-8"?>
...
const BannerComponent = class {
    ...
    renderList() {
        return this.items.map((item) => {
            return [
                index.h("li", { class: { 'active': item.active, 'small-indicator': item.isThreeAway, 'hide': item.isFourAway } }),
            ];
        });
    }
    setBannerItemWidth() {
    ...
    render() {
        return [
            index.h("div", { class: "se-banner" }, index.h("div", { class: "banner-items", ref: el => this.bannerIndicatorEl = el, style: { width: '' + this.items.length * 100 + '%' } }, index.h("slot", null)), this.items.length > 1 ? [
                index.h("ol", { class: "banner-indicators" }, this.renderList()),
                index.h("se-icon", { class: "previous-indicator", onClick: () => this.changeActive('previous') }, index.h("span", { innerHTML: arrow2_left })),
                index.h("se-icon", { class: "next-indicator", onClick: () => this.changeActive('next') }, index.h("span", { innerHTML: arrow2_right.arrow2_right }))
            ]
                : '')
        ];
    }
...
const BannerItemComponent = class {
    ...
    render() {
        return (index.h(index.Host, { class: { 'active': this.active } }, index.h("div", { class: "image-container" }, index.h("div", { class: "image-background", style: { backgroundImage: this.imageUrl } }), index.h("div", { class: "background-overlay" })), index.h("div", { class: "banner-section-wrapper" }, index.h("slot", null))));
    }
    get el() { return index.getElement(this); }
...
exports.se_banner = BannerComponent;
exports.se_banner_item = BannerItemComponent;
