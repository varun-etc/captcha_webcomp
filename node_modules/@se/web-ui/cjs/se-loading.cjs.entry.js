...
const LoadingComponent = class {
    ...
    render() {
        return (index.h(index.Host, { class: { 'show': this.loading } }, index.h("div", { class: "loading-wrapper" }, index.h("div", { class: ["se-loading", this.option].join(' ') }, index.h("div", { class: "loading-icon", innerHTML: spinner }))), index.h("div", { class: "loading-background" })));
    }
};
LoadingComponent.style = loadingCss;

exports.se_loading = LoadingComponent;
