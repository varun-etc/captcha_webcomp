...
const DialogComponent = class {
    constructor(hostRef) {
        ...
        this.backdrop = index.createEvent(this, "backdrop", 7);
    ...
    render() {
        return (index.h("div", { class: `${this.size} dialog-wrapper` }, index.h("div", { class: "dialog-background", onClick: () => this.backdropClicked(), ref: el => this.backdropEl = el }), index.h("div", { class: "dialog", ref: el => (this.menuInnerEl = el) }, index.h("slot", null))));
    }
...
const DialogContentComponent = class {
    ...
    render() {
        return (index.h("div", { class: ['se-dialog-content', this.option === 'fill' ? 'full-content' : ''].join(' ') }, index.h("span", { class: "se-icon-wrapper" }, this.icon ? index.h("se-icon", { size: "large", color: this.iconColor }, index.h("span", { innerHTML: this.icon })) : '', index.h("slot", { name: "icon" })), index.h("div", { class: "inner-content" }, index.h("slot", null))));
    }
};
...
const DialogHeaderComponent = class {
    ...
    render() {
        return (index.h("div", { class: ['se-dialog-header', this.color].join(' ') }, index.h("div", { class: "flex middle" }, index.h("slot", null)), index.h("slot", { name: "end" })));
    }
};
DialogHeaderComponent.style = dialogHeaderCss;

exports.se_dialog = DialogComponent;
exports.se_dialog_content = DialogContentComponent;
exports.se_dialog_footer = DialogFooterComponent;
exports.se_dialog_header = DialogHeaderComponent;
